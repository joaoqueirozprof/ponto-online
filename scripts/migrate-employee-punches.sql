-- Migration: Transfer punches and timesheets from old employee IDs to new (updated) employee IDs
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hqb70xn6gw0wqjwfuv7y' WHERE "employeeId" = 'cmmh29yp30059bz9p0zcu9ftn';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hq900xn4gw0wfou371lj' WHERE "employeeId" = 'cmmh29xql0047bz9p07dyq3mp';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hq6z0xn2gw0wh7hlsipp' WHERE "employeeId" = 'cmmh29zg10063bz9pu8p89ent';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hq4y0xn0gw0w674z4wh7' WHERE "employeeId" = 'cmmh2a08p006zbz9pgg70c6bf';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hq2n0xmygw0wseb0zse4' WHERE "employeeId" = 'cmmh2a01g006rbz9px6efy5il';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hq0i0xmwgw0wkg7izpcj' WHERE "employeeId" = 'cmmh29ywl005hbz9pk4lvy25b';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpyd0xmugw0wixtbnfeb' WHERE "employeeId" = 'cmmh29yht0051bz9prr3pi0b1';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpwf0xmsgw0wjufmae43' WHERE "employeeId" = 'cmmh29yun005fbz9prd50t65g';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpuj0xmqgw0wtss4hmfc' WHERE "employeeId" = 'cmmh29yjl0053bz9pws1a67eg';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpso0xmogw0wj1rjpzwu' WHERE "employeeId" = 'cmmh2a2ap0099bz9pawsa338m';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpqt0xmmgw0wkdtx9rpd' WHERE "employeeId" = 'cmmh2a2k5009jbz9p8wzz1mkm';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpow0xmkgw0w3ls1en7x' WHERE "employeeId" = 'cmmh29zch005zbz9p5owtjgo1';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpmu0xmigw0w9urwqrpd' WHERE "employeeId" = 'cmmh29yli0055bz9plq51a4kf';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpkv0xmggw0wkwjd7bqu' WHERE "employeeId" = 'cmmh2a1ci0087bz9puge9tlpa';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpj20xmegw0wvtyour9i' WHERE "employeeId" = 'cmmh29zhv0065bz9p4fs1tjev';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hph00xmcgw0wobsuj8km' WHERE "employeeId" = 'cmmh29xbz003rbz9pb7ov8x58';
...
UPDATE "Timesheet" SET "employeeId" = 'cmmh3hpf10xmagw0wtnpkpzjs' WHERE "employeeId" = 'cmmh2a0c80073bz9p67l0bxuy';

-- Now deactivate the old duplicate employee records
